...
insert into forced_updating ( platform, version, rule, updata_time, url)
				   values
				   ("Android", "8.5.0", 10000, 1633519472000, "https://www.pgyer.com/xlbk");
insert into forced_updating ( platform, version, rule, updata_time, url)
				   values
				   ("ios", "8.5.0", 10000, 1633519472123, "https://www.pgyer.com/rRut");
insert into forced_updating ( platform, version, rule, updata_time, url)
				   values
				   ("PC", "8.5.0", 10000, 1633519472121, "https://github.com/TastSong/CrazyCar/releases/latest");    
insert into forced_updating ( platform, version, rule, updata_time, url)
				   values
