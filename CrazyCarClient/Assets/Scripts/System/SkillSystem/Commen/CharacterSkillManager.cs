    ...
    public class CharacterSkillManager : MonoBehaviour {
        ...
        private void InitSkill(SkillData data) {
            if (data.prefabName != null) {
                Addressables.LoadAssetAsync<GameObject>("Assets/AB/Skill/SkillPrefab/" + data.prefabName + ".prefab")
                    .Completed += (go) => { data.skillPrefab = go.Result; };
                Addressables.LoadAssetAsync<Sprite>("Assets/AB/Skill/SkillIcon/" + data.skillIconName + ".png")
                    .Completed += (sprite) => { data.skillIcon = sprite.Result; };
