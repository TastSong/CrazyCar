<template>
  <div class="app-container">
    ...
    <el-dialog title="Update Time Trial" :visible.sync="dialogFormVisible">
...
import { getTimeTrialInfos, updateTimeTrialInfo } from '@/api/trial'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getTimeTrialInfos(this.listQuery).then(response => {
    ...
    handleHasWaterChange(row) {
      ...
      updateTimeTrialInfo(tempData).then(response => {
